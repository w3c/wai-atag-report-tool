    ...
    guidelines: [
      {
        ...
        description:
          "The full editing experience conforms to WCAG 2.0 (or other accessibility guidelines).",
        atag_id: "A.1.1",
        scs: [
          {
      ...
      },
      {
        ...
        description:
          "If the interface is not on the web, it conforms to platform-specific accessibility guidelines.",
        atag_id: "A.1.2"
      }
    ]
  },
  {
    principle: "Editing experience is perceivable ",
    guidelines: [
      {
        id: "alt-available",
        name: "Alternative content available to editors",
        description:
          "If there is anything visible that is not text, like icons, images or video, there is alternative text available.",
        atag_id: "A.2.1"
      },
      {
        ...
        description:
          "Status indicators (like changes or spelling errors) and text properties (like italics or bold) are conveyed to users of assistive technologies.",
        atag_id: "A.2.2"
      }
    ]
  },
  {
    principle: "Editing experience is operable",
    guidelines: [
      {
      ...
      },
      {
        ...
        name: "Enough time",
        description:
          "Time limits in the editor, like for auto-save, can be turned off or extended (some exceptions apply).",
        atag_id: "A.3.2"
      },
      {
        ...
        description:
          "Flashing content, like videos, including previews of that kind of content, can be paused or turned off.",
        atag_id: "A.3.3"
      },
      {
      ...
      },
      {
        ...
        description:
          "Users can search in text content, results are focused when shown. If there are no matches, this is indicated. User can search in two directions (backwards and forwards).",
        atag_id: "A.3.5"
      },
      {
        ...
        description:
          "If there are user settings for display, this only affects the editing view, not the output. If a content editor uses OS settings like high contrast mode or their own stylesheet, this does not break the editing experience.",
        atag_id: "A.3.6"
      },
      {
        ...
        description:
          "When the tool shows a preview of the content, that preview is at least as accessible as in current browsers and other user agents.",
        atag_id: "A.3.7"
      }
    ]
  },
  {
    principle: "Editing experience is understandable",
    guidelines: [
      {
        id: "prevent-mistakes",
