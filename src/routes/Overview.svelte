...
<details>
  ...
  <p>
    ...
    . Each principle has a number of
    <strong>Guidelines</strong>
    , which are further divided into
    <strong>Success Criteria</strong>
    . For each, you can select a result and note down any observations. Results
    include "Not checked", "Passed", "Failed", "Not applicable", and "Cannot
    tell".
  </p>
  <p>
    Part A (Principles A.1 to A.4) is related to the
    <strong>editing experience</strong>
    with the authoring tool. It helps ensure that content can be created by
  ...
  <p>
    ...
    . Links in this tool lead you to the relevant sections of the “Implementing”
    document.
  </p>
</details>
